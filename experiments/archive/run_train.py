...
class ModelArguments:
    ...
    cache_dir: Optional[str] = field( #### Not in no_trainer.py
        default=None,
        metadata={"help": "Where to store the pretrained models downloaded from huggingface.co"},
    )
    use_fast_tokenizer: bool = field( #### Not in no_trainer.py
        default=True,
        metadata={"help": "Whether to use one of the fast tokenizer (backed by the tokenizers library) or not."},
    )
    model_revision: str = field( #### Not in no_trainer.py
        default="main",
        metadata={"help": "The specific model version to use (can be a branch name, tag name or commit id)."},
    )
    use_auth_token: bool = field( #### Not in no_trainer.py
        default=False,
        metadata={
...
def main():
    ...
    model_args, data_args, training_args, gen_args, tune_args = parser.parse_dict(my_dict)
    '''
